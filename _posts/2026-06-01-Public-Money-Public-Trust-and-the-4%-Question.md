...
<svg viewBox="0 0 720 360" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Tax funnel: from 146 crore population to ~2.5 crore meaningful income-tax payers" style="max-width:100%;height:auto;font-family:Georgia,'Times New Roman',serif;">
  <rect width="720" height="360" fill="#ffffff"/>
  <text x="360" y="34" text-anchor="middle" font-size="18" font-weight="bold" fill="#1f3a39">The Indian Tax Funnel</text>
  <text x="360" y="54" text-anchor="middle" font-size="12.5" fill="#6b7280">A broad consumption base, a narrow income-tax base</text>
  <!-- Funnel layers -->
  <polygon points="60,80 660,80 600,140 120,140" fill="#1f6f6b"/>
  <text x="360" y="108" text-anchor="middle" font-size="14" font-weight="bold" fill="#ffffff">~146 crore people</text>
  <text x="360" y="126" text-anchor="middle" font-size="11.5" fill="#dff0ee">Total population</text>
  <polygon points="120,150 600,150 530,210 190,210" fill="#3c8f88"/>
  <text x="360" y="178" text-anchor="middle" font-size="14" font-weight="bold" fill="#ffffff">~9 crore file an ITR</text>
  <text x="360" y="196" text-anchor="middle" font-size="11.5" fill="#e6f3f1">about 6% of the population</text>
  <polygon points="190,220 530,220 440,280 280,280" fill="#d98c3f"/>
  <text x="360" y="248" text-anchor="middle" font-size="14" font-weight="bold" fill="#ffffff">~2–3 crore pay real income tax</text>
  <text x="360" y="266" text-anchor="middle" font-size="11.5" fill="#fbeede">~63% of filers owe zero tax</text>
  <!-- GST note -->
  <rect x="200" y="300" width="320" height="44" rx="6" fill="#f4ede2" stroke="#d98c3f"/>
  <text x="360" y="320" text-anchor="middle" font-size="12.5" font-weight="bold" fill="#8a531a">But nearly all 146 crore pay GST</text>
  <text x="360" y="337" text-anchor="middle" font-size="11" fill="#8a531a">Indirect tax reaches almost everyone</text>
</svg>
...
<svg viewBox="0 0 720 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="The double-payment cycle: citizen pays tax, then pays privately again" style="max-width:100%;height:auto;font-family:Georgia,'Times New Roman',serif;">
  <rect width="720" height="240" fill="#ffffff"/>
  <text x="360" y="30" text-anchor="middle" font-size="18" font-weight="bold" fill="#1f3a39">The Double-Payment Cycle</text>
  <!-- Citizen -->
  <rect x="40" y="90" width="150" height="70" rx="10" fill="#1f6f6b"/>
  <text x="115" y="122" text-anchor="middle" font-size="14" font-weight="bold" fill="#ffffff">Citizen</text>
  <text x="115" y="142" text-anchor="middle" font-size="11" fill="#dff0ee">pays tax</text>
  <!-- arrow 1 -->
  <line x1="190" y1="115" x2="290" y2="115" stroke="#3c8f88" stroke-width="3"/>
  <polygon points="290,109 304,115 290,121" fill="#3c8f88"/>
  <text x="240" y="104" text-anchor="middle" font-size="11" fill="#3c8f88">① taxes</text>
  <!-- State -->
  <rect x="305" y="90" width="150" height="70" rx="10" fill="#3c8f88"/>
  <text x="380" y="116" text-anchor="middle" font-size="14" font-weight="bold" fill="#ffffff">The State</text>
  <text x="380" y="136" text-anchor="middle" font-size="11" fill="#e6f3f1">thin public delivery</text>
  <!-- arrow 2 -->
  <line x1="455" y1="115" x2="555" y2="115" stroke="#d98c3f" stroke-width="3"/>
  <polygon points="555,109 569,115 555,121" fill="#d98c3f"/>
  <text x="510" y="104" text-anchor="middle" font-size="11" fill="#d98c3f">gap remains</text>
  <!-- Private -->
  <rect x="570" y="90" width="120" height="70" rx="10" fill="#d98c3f"/>
  <text x="630" y="116" text-anchor="middle" font-size="13" font-weight="bold" fill="#ffffff">Private</text>
  <text x="630" y="136" text-anchor="middle" font-size="11" fill="#fbeede">hospital · school</text>
  <!-- return arrow (second payment) -->
  <path d="M630 160 Q630 205 115 205 L115 165" fill="none" stroke="#b3541e" stroke-width="3" stroke-dasharray="7,5"/>
  <polygon points="109,178 115,162 121,178" fill="#b3541e"/>
  <text x="370" y="225" text-anchor="middle" font-size="12.5" font-weight="bold" fill="#b3541e">② the citizen pays a second time, out of pocket</text>
</svg>
...
<svg viewBox="0 0 720 230" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Health budget split: modern medicine 96 percent, AYUSH 4 percent" style="max-width:100%;height:auto;font-family:Georgia,'Times New Roman',serif;">
  <rect width="720" height="230" fill="#ffffff"/>
  <text x="360" y="32" text-anchor="middle" font-size="18" font-weight="bold" fill="#1f3a39">The 96 / 4 Split (FY 2026–27)</text>
  <text x="360" y="52" text-anchor="middle" font-size="12.5" fill="#6b7280">Central health allocation: mainstream vs AYUSH</text>
  <!-- stacked bar -->
  <rect x="40" y="90" width="614" height="60" fill="#1f6f6b"/>
  <rect x="654" y="90" width="26" height="60" fill="#d98c3f"/>
  <rect x="40" y="90" width="640" height="60" fill="none" stroke="#1f3a39" stroke-width="1"/>
  <!-- labels -->
  <text x="347" y="126" text-anchor="middle" font-size="14" font-weight="bold" fill="#ffffff">MoHFW ~₹1.06 lakh cr — 96%</text>
  <!-- AYUSH callout -->
  <line x1="667" y1="90" x2="667" y2="66" stroke="#b3541e" stroke-width="1.5"/>
  <text x="667" y="58" text-anchor="middle" font-size="12.5" font-weight="bold" fill="#b3541e">AYUSH</text>
  <text x="667" y="178" text-anchor="middle" font-size="13" font-weight="bold" fill="#b3541e">~₹4,409 cr</text>
  <text x="667" y="194" text-anchor="middle" font-size="12" fill="#b3541e">≈ 4%</text>
  <!-- footnote -->
  <text x="40" y="218" font-size="11" fill="#6b7280">Parliament's standing committee recommended 5%, then 10%, for AYUSH. The share has fallen since 2023–24.</text>
</svg>
...
<svg viewBox="0 0 760 330" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="How the FY 2025-26 AYUSH budget of 3,992.90 crore was allocated" style="max-width:100%;height:auto;font-family:Georgia,'Times New Roman',serif;">
  <rect width="760" height="330" fill="#ffffff"/>
  <text x="380" y="30" text-anchor="middle" font-size="18" font-weight="bold" fill="#1f3a39">Where the AYUSH money went (FY 2025–26)</text>
  <text x="380" y="50" text-anchor="middle" font-size="12.5" fill="#6b7280">Total: ₹3,992.90 crore — apparatus vs. delivery</text>
  <!-- Row 1: Autonomous bodies -->
  <text x="228" y="84" text-anchor="end" font-size="12.5" font-weight="bold" fill="#1f3a39">Autonomous bodies</text>
  <text x="228" y="99" text-anchor="end" font-size="10.5" fill="#6b7280">councils · institutes · universities</text>
  <rect x="240" y="72" width="430" height="34" fill="#2c6e6a"/>
  <text x="678" y="94" font-size="12.5" font-weight="bold" fill="#1f3a39">₹1,965.80 cr · 49%</text>
  <!-- Row 2: NAM -->
  <text x="228" y="142" text-anchor="end" font-size="12.5" font-weight="bold" fill="#b3541e">National AYUSH Mission</text>
  <text x="228" y="157" text-anchor="end" font-size="10.5" fill="#6b7280">grassroots care · +6.25% only</text>
  <rect x="240" y="130" width="279" height="34" fill="#d98c3f"/>
  <text x="527" y="152" font-size="12.5" font-weight="bold" fill="#b3541e">₹1,275 cr · 32%</text>
  <!-- Row 3: Other -->
  <text x="228" y="200" text-anchor="end" font-size="12.5" font-weight="bold" fill="#1f3a39">Secretariat, schemes,</text>
  <text x="228" y="215" text-anchor="end" font-size="10.5" fill="#6b7280">regulators &amp; other</text>
  <rect x="240" y="188" width="156" height="34" fill="#8aa6a3"/>
  <text x="404" y="210" font-size="12.5" font-weight="bold" fill="#1f3a39">₹712 cr · 18%</text>
  <!-- Row 4: Plants + pharma -->
  <text x="228" y="258" text-anchor="end" font-size="12.5" font-weight="bold" fill="#1f3a39">Medicinal plants + drug</text>
  <text x="228" y="273" text-anchor="end" font-size="10.5" fill="#6b7280">standardisation (PCIM&amp;H)</text>
  <rect x="240" y="246" width="9" height="34" fill="#cdb892"/>
  <text x="257" y="268" font-size="12.5" font-weight="bold" fill="#1f3a39">₹41 cr · 1%</text>
  <!-- footnote -->
  <line x1="240" y1="296" x2="240" y2="62" stroke="#e5e5e5" stroke-width="1"/>
  <text x="40" y="318" font-size="11" fill="#6b7280">A system built on herbal medicine spends ~1% of its budget on medicinal plants and drug standards.</text>
</svg>
